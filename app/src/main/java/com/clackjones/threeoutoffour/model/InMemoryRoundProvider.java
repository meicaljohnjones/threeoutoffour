...
public class InMemoryRoundProvider {
// TODO: Old impl - move to rounds.json

    //    private static InMemoryRoundProvider roundProvider = null;
//    private Map<Integer, Round> rounds = new HashMap<>();
//
//    private InMemoryRoundProvider() {
//
//    }
//
//    public static InMemoryRoundProvider getInstance() {
//        if (RoundProvider.roundProvider == null) {
//            RoundProvider.roundProvider = new InMemoryRoundProvider();
//            RoundProvider.roundProvider.initialize();
//        }
//        return InMemoryRoundProvider.roundProvider;
//    }
//
